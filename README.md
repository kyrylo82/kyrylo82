...
| User AI session hours | 0,0h | 13,0h | 56,0h | 56,0h |
| AI worker hours | 0,0h | 3,0h | 0,0h | 163,0h |
| AI concurrency hours | 0,0h | 22,0h | 0h | 0h |
| Interactive sessions | 1 | 12 | 30 | 30 |
| Worker sessions | 0 | 1 | 2 | 184 |

_Screen time from macOS display events, snapshotted daily. *365-day extrapolated (accumulating real data)._

_User AI session hours are attended interactive time measured from gaps between AI responses and the next user message; AI concurrency hours include attended time, AI generation, and background workers._

_AI session 365-day totals cover 24 days of local assistant session history (not extrapolated)._

## AI Model Usage (last 30 days)

| Model | Requests | Input | Output | Cache read | API Cost | Cache savings | Model savings |
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| gpt-5.5 | 5,240 | 38.6M | 1.5M | 664.3M | $0 | $0 | $0 |
| deepseek-v4-flash-free | 7 | 160K | 953 | 214K | $0 | $0 | $0 |
| **Total** | **5,247** | **38.7M** | **1.5M** | **664.5M** | **$0** | **$0** | **$0** |

_704.8M total tokens processed. 94.3% cache hit rate._
...
| gpt-5.5 | 8,245 | 56.5M | 2.3M | 1,015.2M | $0 | $0 | $0 |
...
| deepseek-v4-flash-free | 7 | 160K | 953 | 214K | $0 | $0 | $0 |
| **Total** | **17,299** | **58.5M** | **7.9M** | **2,068.6M** | **$0** | **$0** | **$0** |

_2,213.5M total tokens processed. 93.5% cache hit rate._
...
<!-- UPDATED-START -->
_Stats auto-updated 2026-07-08 16:07 UTC by [aidevops](https://aidevops.sh) pulse._
<!-- UPDATED-END -->
